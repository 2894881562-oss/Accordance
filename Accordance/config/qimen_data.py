...
QIMEN_STEM_MEANING = {
    "乙": {"type": "三奇", "score": 1.4, "meaning": "日奇，主柔和、生机、文书与人缘。"},
    "丙": {"type": "三奇", "score": 1.2, "meaning": "月奇，主显达、光明、声势与传播。"},
    "丁": {"type": "三奇", "score": 1.3, "meaning": "星奇，主灵感、精细、贵助与机巧。"},
    "戊": {"type": "六仪", "score": 0.4, "meaning": "甲子戊，主资本、根基、主帅与承载。"},
    "己": {"type": "六仪", "score": 0.0, "meaning": "甲戌己，主细碎、落实、隐患与修补。"},
    "庚": {"type": "六仪", "score": -1.2, "meaning": "甲申庚，主阻力、对抗、硬冲与变故。"},
    "辛": {"type": "六仪", "score": -0.4, "meaning": "甲午辛，主错误、精细压力、修正与代价。"},
    "壬": {"type": "六仪", "score": 0.1, "meaning": "甲辰壬，主流动、变化、远路与信息。"},
    "癸": {"type": "六仪", "score": -0.1, "meaning": "甲寅癸，主隐伏、迟疑、收束与细节。"},
}
