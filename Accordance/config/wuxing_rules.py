...
# 六冲卦（据《增删卜易·六冲章》）
# 原文："六冲卦者，乾坎艮震巽离坤兑八宫之首卦，及天雷无妄、雷天大壮，共十卦。"
# 六冲卦上卦三爻与下卦三爻对应相冲（子午冲、丑未冲、寅申冲、卯酉冲、辰戌冲、巳亥冲）。
LIUCHONG_HEXAGRAMS = PURE_HEXAGRAM_NAMES | {
    "天雷无妄", "雷天大壮",
}

# 六合卦（据《增删卜易·六合章》及《卜筮正宗》）
# 上卦三爻与下卦三爻对应相合（子丑合、寅亥合、卯戌合、辰酉合、巳申合、午未合）。
# 核心八合：天地否、水泽节、山火贲、雷地豫、火山旅、地雷复、地天泰、泽水困。
# 另有一说雷风恒、风雷益、火风鼎、风水涣亦为六合，此处取较广义版本以供参考。
LIUHE_HEXAGRAMS = {
    "天地否", "地天泰",
    "山火贲", "火山旅",
    "水泽节", "泽水困",
