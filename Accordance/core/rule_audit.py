...
REQUIRED_HISTORY_WIRING = {
    ...
    "modules/full_divination.py": ("六爻详占", ("handle_duplicate_check", "record_question", "context=f\"外应：")),
    "modules/quick_divination.py": ("三爻快占", ("handle_duplicate_check", "record_question", "context=f\"外应：")),
