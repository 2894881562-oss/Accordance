...
LIUQIN_KEYWORD_RULES = [
    {
        ...
        "secondary": "世爻",
        "keywords": [
            "寻物", "找东西", "寻找", "丢", "丢失", "失物", "遗失", "落下",
            "钱包", "手机", "钥匙", "证件", "物品", "东西", "找回",
        ],
        "reason": "失物多以妻财为物象，兼看世爻、动爻、伏神与卦身判断远近显隐。",
    },
    {
        "category": "医药治疗",
        "yongshen": "子孙",
        "secondary": "官鬼",
        "keywords": [
            "治疗", "医生", "医药", "药", "药效", "康复", "复诊", "手术",
            "检查", "体检", "住院", "疗程", "就医", "平安",
        ],
        "reason": "专问治疗、医药与解忧，以子孙为医药福神，兼看官鬼病象轻重。",
    },
    {
        "category": "疾病病象",
        "yongshen": "官鬼",
        "secondary": "子孙",
        "keywords": [
            "疾病", "病", "身体", "健康", "症状", "疼", "痛", "发烧",
            "咳嗽", "肠胃", "头晕", "失眠", "不舒服", "伤", "灾厄",
        ],
        "reason": "占病以官鬼为病象，子孙为医药解忧；官鬼旺动须重视现实检查。",
    },
    {
        "category": "出行行人",
        "yongshen": "子孙",
        "secondary": "世应",
        "keywords": [
            "出行", "旅行", "旅游", "路上", "行程", "航班", "车票", "开车",
            "回家", "回来", "远行", "搬家", "通勤", "交通", "安全",
        ],
        "reason": "出行重安全与顺遂，以子孙为解忧平安之象，兼看世应、动爻与冲合。",
    },
    {
        "category": "财货经营",
        "yongshen": "妻财",
...
def infer_yongshen_from_question(question_text, fallback="世爻"):
    ...
    if best_rule:
        return {
            ...
            "secondary": best_rule.get("secondary", ""),
